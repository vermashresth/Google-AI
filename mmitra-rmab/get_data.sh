...
FROM dialer_logs
WHERE startdatetime >= '2021-02-16' AND startdatetime < '2021-05-03'
AND  user_id IN
(SELECT u.id FROM users u
WHERE entry_date >= '2021-02-16' AND entry_date < '2021-03-16');" | /google/data/ro/projects/speckle/mysql -h 34.93.230.87 -P 3306 -u ${USERNAME} --password=${PASSWORD} mmitra > feb16-mar15_data/call/pilot_call_data.csv