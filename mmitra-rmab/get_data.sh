...
echo "SELECT u.beneficiary_id user_id, isactive, MD5(phone_no) phone_no, lmp_date lmp, enrollment_gestation_age enroll_gest_age, u.project_id, u.call_slot_id call_slots, enrollment_delivery_status enroll_delivery_status,
