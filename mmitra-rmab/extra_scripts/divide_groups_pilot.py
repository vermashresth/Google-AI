...
opt_out_list = opt_out_excel[0].to_list()
...
write_file(rmab_filtered_ids[:CONFIG['top-k']], 'outputs/pilot_generations/rmab_list_{}_{}_{}.txt'.format(CONFIG['top-k'], CONFIG['week'], CONFIG['date']))
...
calling_list = rmab_filtered_ids[:CONFIG['top-k']] + round_robin_filtered_ids[:CONFIG['top-k']]
