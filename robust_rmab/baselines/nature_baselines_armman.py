...
class PessimisticNaturePolicy:
    ...
    #     for arm_i in range(actions.shape[0]):
    #         for arm_a in range(actions.shape[1]):
    #             param_lower = self.nature_params[arm_i, arm_a%2, arm_a//2, 0]
    #             actions[arm_i, arm_a] = param_lower
    ...
    def get_nature_action(self, o):
        ...
        for arm_i in range(actions.shape[0]):
            for arm_s in range(actions.shape[1]):
                for arm_a in range(actions.shape[2]):
                    param_lower = self.nature_params[arm_i, arm_s, arm_a, 0]
                    actions[arm_i, arm_s, arm_a] = param_lower
...
class OptimisticNaturePolicyIndividual:
    def __init__(self, nature_params, ind):
        self.nature_params=nature_params
        self.ind = ind
...
class OptimisticNaturePolicy:
    ...
    #         arm_state = int(o[arm_i])
    #         for arm_a in range(actions.shape[1]):
    #             param_upper = self.nature_params[arm_i, arm_a%2, arm_a//2, 1]
    #             actions[arm_i, arm_a] = param_upper
    ...
    def get_nature_action(self, o):
        ...
        for arm_i in range(actions.shape[0]):
            for arm_s in range(actions.shape[1]):
                for arm_a in range(actions.shape[2]):
                    param_upper = self.nature_params[arm_i, arm_s, arm_a, 1]
                    actions[arm_i, arm_s, arm_a] = param_upper
...
class MiddleNaturePolicyIndividual:
...
class MiddleNaturePolicy:
    ...
    #         arm_state = int(o[arm_i])
    #         for arm_a in range(actions.shape[1]):
    #             param_mean = self.nature_params[arm_i, arm_a%2, arm_a//2].mean()
                
    #             if self.perturbations is not None:
    #                 param_range = np.ptp(self.nature_params[arm_i, arm_a%2, arm_a//2])
    #                 perturb_width = param_range*self.perturbation_size
    #                 perturbation = self.perturbations[arm_i, arm_a%2, arm_a//2]
    #                 perturbation = perturbation*perturb_width*2 - perturb_width
    #                 print(self.nature_params[arm_i, arm_a%2, arm_a//2])
    #                 print(perturbation)
    #                 print('before',param_mean)    
    #                 param_mean = param_mean + perturbation
    #                 print('after',param_mean)
    ...
    def get_nature_action(self, o):
        ...
        for arm_i in range(actions.shape[0]):
            for arm_s in range(actions.shape[1]):
                for arm_a in range(actions.shape[2]):
                    param_mean = self.nature_params[arm_i, arm_s, arm_a].mean()
                    
                    if self.perturbations is not None:
                        param_range = np.ptp(self.nature_params[arm_i, arm_s, arm_a])
                        perturb_width = param_range*self.perturbation_size
                        perturbation = self.perturbations[arm_i, arm_s, arm_a]
                        perturbation = perturbation*perturb_width*2 - perturb_width
                        # print(self.nature_params[arm_i, arm_s, arm_a])
                        # print(perturbation)
                        # print('before',param_mean)    
                        param_mean = param_mean + perturbation
                        # print('after',param_mean)
                    ...
                    actions[arm_i, arm_s, arm_a] = param_mean
