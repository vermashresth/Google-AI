...
class RMABWhittleNatureOracle(nn.Module):
    ...
    def step(self, obs, a_agent_list):
        with torch.no_grad():
            if not self.one_hot_encode:
            ...
            ## Review: how to give agent's actions here
        ...
        return a_nature.numpy(), v_nature.numpy(), logp_a_nature.numpy(), q_nature
